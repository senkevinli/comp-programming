...
if __name__ == "__main__":
    print(f"Please go to https://ramp.com/careers and use this secret when you apply: {generate_secret()}\n")
    # sys.stdout(
    #     f"Please go to https://ramp.com/careers and use this secret when you apply: {generate_secret()}\n"
    # )